/* Общий хедer/футер, инжектируются на каждой странице.
   ...
   язык — атрибутом lang на <html>.

   Внутри сайта трио ссылки на его же страницы — относительные (recordings.html,
   не /recordings.html). Ссылки на другой сайт (сайт трио → сайт Веры и наоборот) —
   полные абсолютные URL с доменом, поскольку это два разных домена. */
